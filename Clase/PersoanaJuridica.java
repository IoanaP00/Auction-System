public class PersoanaJuridica extends Client {
    ...
    public PersoanaJuridica(int id, String nume, String adresa, Companie companie, double capitalSocial) {
    ...
    /**
     * Asociaza aleator persoanei juridice o valoare a pretului initial
    ...
    /**
     * Asociaza persoanei juridice aleator o valoare a unui pret intermediar, prin adaugarea unui procent random
    ...
    /**
     * Anunta casa de licitatii ca o persoana juridica s-a inscris la o licitatie pentru un anumit produs
